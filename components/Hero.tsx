...
const Hero = () => {
  return (
    <div className="pb-20 pt-36">
      ...
      <div className="h-screen w-full dark:bg-black-100 bg-grid-black/[0.2] flex items-center justify-center absolute top-0 left-0">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center text-white">
          <div className="text-center text-[40px] md:text-5xl lg:text-[3.2rem] !leading-snug tracking-wide font-bold text-white my-5">
            Transforming Concepts into Seamless{" "}
            <span className="text-purple"> User Experiences </span>
          </div>

          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hi, I&apos;m Bhavya, a Web Developer based in India
          </p>
